...
\begin{figure}[!tb]
\centering
\subfloat[Success Case]{\includegraphics[width = 0.45\linewidth]{figures/GFC/GFCsuccess_labels.eps}~\includegraphics[width = 0.45\linewidth]{figures/GFC/GFCsuccess_base.eps}}

\subfloat[Failure Case]{\includegraphics[width = 0.45\linewidth]{figures/GFC/GFCfailure_labels.eps}~\includegraphics[width = 0.45\linewidth]{figures/GFC/GFCfailure_base.eps}}
...
\begin{figure}[!tb]
\centering
\subfloat[Success Case]{\includegraphics[width = 0.45\linewidth]{figures/LFC/LFCsuccess_labels.eps}~\includegraphics[width = 0.45\linewidth]{figures/LFC/LFCsuccess_base.eps}}

\subfloat[Failure Case]{\includegraphics[width = 0.45\linewidth]{figures/LFC/LFCfailure_labels.eps}~\includegraphics[width = 0.45\linewidth]{figures/LFC/LFCfailure_base.eps}}
...
As a result of the slowness of convergence of our Yinyang implementation, many of the larger data sets that we were able to test did not even see convergence after the limit of 1,000 iterations.

Finally, time per iteration was also worse in our implementation than in classic K-means, although the difference was not as great as the previous metrics.
...
This difference shrank as the data set got larger: the largest tested set, 100 clusters, 1,000 samples per cluster, 1,000 features, and an inter-cluster distance of 1,000, saw average per-iteration times of 12.145 seconds for classic K-means and 12.763 seconds for our implementation of Yinyang K-means.
