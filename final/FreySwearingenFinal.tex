...
%figure here%
A plot of the number of iterations taken on the largest data sets we ran (100 clusters, 1,000 samples per cluster, 100-1,000 features, and an inter-cluster distance of 100-1,000) can be seen in figure \verb|___|.
...
These results can be seen in figure \verb|___|.
